 ...
 * IDL can be found at `target/idl/umbraauctions.json`.
 */
export type Umbraauctions = {
  "address": "8kUjxXEnqKNC6ny2tRuJGQMyPqefF6SyGyhbvQWzyaDE",
  "metadata": {
    "name": "umbraauctions",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "errors": [
    ...
    {
      "code": 6008,
      "name": "settlementNotComputed",
      "msg": "Settlement has not been computed"
    },
    {
      "code": 6009,
      "name": "settlementAlreadyComputed",
    ...
    {
      "code": 6016,
      "name": "winnerCannotRefundAsLoser",
